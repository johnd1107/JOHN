...
# Calcular el promedio de temperaturas por semana y por ciudad
for i, ciudad in enumerate(temperaturas):
    ...
    for j, semana in enumerate(ciudad):
        ...
        print(f"  Semana {j + 1}: Promedio de la temperatura = {promedio_semana:.2f}°F")
        # Añadimos la suma de la semana al total de la ciudad
        suma_total += suma_semana
        num_dias += len(semana)

    # Calculamos el promedio total por ciudad
    promedio_ciudad = suma_total / num_dias
    print(f"Promedio total de la ciudad {i + 1} = {promedio_ciudad:.2f}°F\n")